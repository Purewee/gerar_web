...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-gray-50 md:py-12">
      <div className="max-w-4xl mx-auto px-0 md:px-6 sm:pt-2 pt-6">
        ...
        <div className="bg-white md:rounded-2xl shadow-sm border-b md:border border-gray-100 overflow-hidden">
          ...
          <div className="bg-linear-to-r from-blue-600 to-indigo-700 px-6 py-8 md:px-8 md:py-12 text-white text-center">
            ...
            <p className="text-blue-100 opacity-90 text-sm md:text-base max-w-2xl mx-auto">
              Gerar.mn сайтыг ашиглахаас өмнө энэхүү үйлчилгээний нөхцөлтэй анхааралтай танилцана
              уу.
            </p>
          </div>
          ...
          <div className="p-5 md:p-12 space-y-8 md:space-y-12">
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-600 leading-relaxed">
                Компани нь гэр ахуйн бараа бүтээгдэхүүнийг Сайтаар дамжуулан онлайн хэлбэрээр
                захиалан худалдаалах, хүргэлтийн үйлчилгээ үзүүлнэ.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <ul className="grid md:grid-cols-2 gap-3 mt-4">
                {[
                  ...
                  <li
                    key={item}
                    className="flex items-center gap-2 text-gray-600 bg-gray-50 p-3 rounded-lg border border-gray-100 italic"
                  >
              ...
              <p className="text-sm text-red-500 mt-2 font-medium">
                * Хэрэглэгчийн буруу, дутуу мэдээллээс шалтгаалсан аливаа саатал, алдаанд Компани
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-600 leading-relaxed">
                Захиалгын төлбөрийг QPay (QR код) эсвэл Банкны аппликейшн ашиглан гүйцэтгэнэ. Төлбөр
                амжилттай баталгаажсанаар захиалга хүчин төгөлдөрт тооцогдоно.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="bg-blue-50 p-6 rounded-xl border border-blue-100">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  {['10:00 – 14:00', '14:00 – 18:00', '18:00 – 21:00', '21:00 – 00:00'].map(
                    time => (
                      <div
                        key={time}
                        className="bg-white p-2 text-center rounded shadow-sm text-sm font-medium text-gray-700 border border-blue-200"
                      >
                        {time}
                      </div>
                    ),
              ...
              <p className="text-gray-600 leading-relaxed mt-4 text-sm">
                Хүргэлт нь сонгосон өдөр, цагийн хуваарийн дагуу хийгдэх бөгөөд замын хөдөлгөөний
                ачаалал, цаг агаар болон бусад нөхцөл байдлаас шалтгаалан тодорхой хэмжээнд
                хэлбэлзэж болно.
              </p>
            </section>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-amber-400 pl-6 py-2">
                  ...
                  <p className="text-gray-600 italic">
                    Бараа гэмтэлтэй, эвдрэлтэй хүргэгдсэн эсвэл захиалсан бараанаас зөрүүтэй бараа
                    хүргэгдсэн тохиолдолд.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-blue-400 pl-6 py-2">
                  ...
                  <p className="text-gray-600 italic">
                    Хэрэглэгч барааг хүлээн авснаас хойш 24 цагийн дотор гомдол гаргана.
                  </p>
                </div>

                <div className="bg-red-50 p-6 rounded-xl border border-red-100">
                  <h3 className="font-bold text-red-800 mb-3">
                    6.4 Буцаалт хийх боломжгүй нөхцөл:
                  </h3>
            ...
            <div className="grid md:grid-cols-2 gap-8 pt-8 border-t border-gray-100">
              ...
              <section className="space-y-4">
                ...
                <p className="text-xs text-gray-500 leading-relaxed italic">
                  Давагдашгүй хүчин зүйлсийн улмаас үйлчилгээ саатах, хүргэлт хойшлох тохиолдолд
                  Компани хариуцлага хүлээхгүй.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Компани нь энэхүү нөхцөлд өөрчлөлт оруулах эрхтэй бөгөөд шинэчилсэн хувилбар
                  байршуулснаар хүчин төгөлдөр болно.
                </p>
              </section>
            </div>
          </div>
