...
function LoyaltyStoreContent() {
  ...
  return (
    <div className="bg-linear-to-b from-yellow-50 via-white to-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 lg:px-6 py-6 sm:py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 bg-white p-6 rounded-2xl shadow-sm border border-yellow-100">
          <div className="flex items-center gap-4">
            <Button
              variant="outline"
              onClick={() => router.back()}
              className="flex items-center gap-2 px-3 py-2 border-2 border-gray-200 hover:border-yellow-500 hover:bg-yellow-50 hover:text-yellow-600 transition-all duration-200 rounded-lg shadow-sm group"
            >
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/20 px-6 py-3 rounded-xl flex items-center gap-4">
              ...
              <div>
                ...
                <span className="text-2xl font-bold text-yellow-700">
                  {user.points.toLocaleString()} <span className="text-sm font-semibold uppercase">оноо</span>
                </span>
              </div>
            </div>
          )}
        ...
        <div className="mb-8 p-4 bg-blue-50 border border-blue-100 rounded-xl flex items-start gap-3">
          ...
          <div className="text-sm text-blue-800">
            <strong>Яаж оноо цуглуулах вэ?</strong> Та 150₮-ийн худалдан авалт тутамдаа 1 оноо цуглуулна. 
            Цуглуулсан оноо бүр нь 1₮-тэй тэнцэх үнэтэй бөгөөд зөвхөн энэ дэлгүүрт ашиглах боломжтой.
          </div>
        </div>
